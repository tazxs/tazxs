...
```typescript
const me = {
  role:     ["Full-Stack Developer", "Quant Engineer", "Systems Builder"],
  stack:    {
    systems:  ["C++20", "Go"],
    data:     ["Python", "NumPy", "Pandas", "PyTorch"],
    web:      ["TypeScript", "Next.js", "React", "TailwindCSS"],
    infra:    ["Docker", "PostgreSQL", "Redis", "Linux"],
  },
  interests: ["Algorithmic Trading", "Low-latency Systems", "Web Apps"]
};
```
